...
public class DoublyLinkedList {
    ...
    public Node deleteFirst() {
        ...
        first = first.next;  // we are assigning the reference of the node
        // following the old fist node to the first field in the linked list object
    ...
    public boolean insertAfter(int key, int data) {
        ...
        if (current == last) {
            ...
            current.next.previous = newNode;  // the node ahead of current field should point to the new node
        }
    ...
    public void displayForward() {
        ...
        Node current = first;  // start from the beginning
        while (current != null) {
            current.displayNode();  // call the display method og the node
